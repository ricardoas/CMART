...
function makeRequest(pageNo) {
	...
	var url = "index?userID=" + userid +"&authToken=" + authToken + "&getRecommendation=1&recommendationPageNo=" + pageNo; 
...
function readXML() {
	...
	for(i = 0; i < items.length; i++) {
		...
		var itemURL = "viewitem?userID=" + userid +"&authToken=" + authToken + "&itemID=" + id;
