...
/**
 * This servlet tests the database for correct functionality
 * 
...
public class TestDBServlet extends HttpServlet {
	...
	private static final long serialVersionUID = 6475551456628458743L;
	private static final String EMPTY = "";
	private static final String title = "Test DB";
	...
	public void makePage(HttpServletRequest request, HttpServletResponse response, Boolean isGet)  throws ServletException, IOException {
		if(request !=null && response != null){
			...
			TestDBController vars = new TestDBController();
			int loopCount = 0;
			do{
	 ...
	 * @author Andy (andrewtu@cmu.edu)
	 */
	public void createHTML4(PrintWriter out, TestDBController vars, Boolean isGet){
		...
		try{
			...
			out.println("ASSERTS MUST BE ENABLED!!");
		}
		catch(Exception e){
			e.printStackTrace();
		}
	 ...
	 * @author Andy (andrewtu@cmu.edu)
	 */
	public void createHTML5(PrintWriter out, TestDBController vars, Boolean isGet){
		if(out != null && vars != null)
		try{
			// Get the data needed to display the page
			vars.getHTML5Data();
