 ...
 * 
 */
@WebServlet(name="ExampleBlankServlet", urlPatterns="/blank")
public class ExampleBlankServlet extends HttpServlet {
	
	private static final long serialVersionUID = 6475041456628458743L;
	private static final String EMPTY = "";
	private static final String title = "Blank Example";
	 ...
	 * @author Andy (andrewtu@cmu.edu)
	 */
	public void createHTML4(PrintWriter out, ExampleBlankController vars, Boolean isGet){
	 ...
	 * @author Andy (andrewtu@cmu.edu)
	 */
	public void createHTML5(PrintWriter out, ExampleBlankController vars, Boolean isGet){
		if(out != null && vars != null)
		try{
			// Get the data needed to display the page
			vars.getHTML5Data();
