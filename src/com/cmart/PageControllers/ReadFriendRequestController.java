...
/**
 * This class processes the data for the read FriendRequest servlet
 * 
...
public class ReadFriendRequestController extends PageController {
	private static final GlobalVars GV = GlobalVars.getInstance();
	
	// Variables passed in the request
	private long userID = -1;
	private String authToken = null;
	private long acceptID = -1;
	private long rejectID = -1;
	...
	public void checkInputs(HttpServletRequest request) {
		...
		if (request != null) {
			...
			try {
				this.acceptID = CheckInputs.checkAcceptID(request);
			} catch (Error e) {
				if (!errors.contains(e))
					errors.add(e);
			}
			...
			try {
				this.rejectID = CheckInputs.checkRejectID(request);
			} catch (Error e) {
				if (!errors.contains(e))
					errors.add(e);
			}
	...
	/**
	 * Returns the list of FriendRequests
	 * 
	 * @return ArrayList<FriendRequest> the list of FriendRequests
	 * @author Chaohua (chaohuam@andrew.cmu.edu, ma.chaohua@gmail.com)
	 */
	public ArrayList<FriendRequest> getFriendRequests() {
		return GV.DB.getFriendRequests(this.userID);
	}

	/**
	 * Returns the list of FriendRequests
	 * 
	 * @return String the name of the user who sends the FriendRequest
	 * @author Chaohua (chaohuam@andrew.cmu.edu, ma.chaohua@gmail.com)
	 */
	...
	/**
	 * Returns the acceptID as a String
	 * 
	 * @return String the acceptID
	 * @author Chaohua (chaohuam@andrew.cmu.edu, ma.chaohua@gmail.com)
	 */
	...
	/**
	 * Returns the rejectID as a String
	 * 
	 * @return String the rejectID
	 * @author Chaohua (chaohuam@andrew.cmu.edu, ma.chaohua@gmail.com)
	 */
	...
	public void confirmFriendRequest(long acceptID) {
		GV.DB.confirmFriendRequest(acceptID);		
	}

	public void rejectFriendRequest(long rejectID) {
		GV.DB.rejectFriendRequest(rejectID);
	}
}