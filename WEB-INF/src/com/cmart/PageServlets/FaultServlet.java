...
@WebServlet(name="FaultServlet", urlPatterns="/fault")
public class FaultServlet extends HttpServlet {
	
	private static final long serialVersionUID = 6665041456628458743L;
	private static final String EMPTY = "";
	private static final String title = "Fault Servlet";
	...
	public void makePage(HttpServletRequest request, HttpServletResponse response, Boolean isGet)  throws ServletException, IOException {
		if(request !=null && response != null){
			...
			FaultController vars = new FaultController();
			int loopCount = 0;
			do{
	 ...
	 * @author Andy (andrewtu@cmu.edu, turner.andy@gmail.com)
	 */
	public void createHTML4(PrintWriter out, FaultController vars, Boolean isGet){
	 ...
	 * @author Andy (andrewtu@cmu.edu, turner.andy@gmail.com)
	 */
	public void createHTML5(PrintWriter out, FaultController vars, Boolean isGet){
		if(out != null && vars != null)
		try{
			// Get the data needed to display the page
			vars.getHTML5Data();
