...
@WebServlet(name="BrowseCategoryServletOld", urlPatterns="/browsecategoryold")
public class BrowseCategoryServletOld extends HttpServlet{
		...
		try{		
			...
			out.println("<div class=\"items\">");
				...
				for(int i=0; i < itemURLs.length; i++){
					 ...
					 * End date
					 */
					out.println("<div class=\"entry\" id=\"entry\">");
					out.println("<div class=\"img\">");
