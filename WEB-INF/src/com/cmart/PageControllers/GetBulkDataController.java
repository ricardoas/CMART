...
/**
 * This controller gets bulk data
 * 
...
public class GetBulkDataController extends PageController{
	...
	ArrayList<String[]> allStates = null;
	...
	public void getHTML4Data() {	
		...
		try {
			allCategories = GV.DB.getAllCategories();
			
			allStates = GV.DB.getStates();
		} catch (Exception e) {
